 ...
 * @section prerequisite 
 */
INT16 rsi_bt_set_connectability_mode(RSI_BT_CMD_SET_CONN_MODE *uSetConnectabilityMode)
{
  INT16          retval;
  ...
  retval = rsi_bt_execute_cmd((UINT08 *)rsi_frameCmdSetConnMode,  (UINT08 *)uSetConnectabilityMode, sizeof(RSI_BT_CMD_SET_CONN_MODE));
  return retval;
}
