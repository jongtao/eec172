...
//
#define  RSI_WIFI_RSP_CARD_READY                          0x0089
...
INT16 rsi_bt_set_connectability_mode(RSI_BT_CMD_SET_CONN_MODE *SetConnMode);
...
INT16 rsi_bt_spp_app_transfer(RSI_BT_CMD_SPP_TRANSFER *SPPTransfer);
