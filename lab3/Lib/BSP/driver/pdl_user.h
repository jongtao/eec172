...
#define PDL_PERIPHERAL_ENABLE_EXINT14           PDL_ON
...
// USB
#define PDL_PERIPHERAL_ENABLE_USB0_DEVICE                 PDL_OFF             //Configured by USB Wizard plugin
#define PDL_PERIPHERAL_ENABLE_USB0_HOST                   PDL_OFF             //Configured by USB Wizard plugin
#define PDL_PERIPHERAL_ENABLE_USB1_DEVICE                 PDL_OFF             //Configured by USB Wizard plugin
#define PDL_PERIPHERAL_ENABLE_USB1_HOST                   PDL_OFF             //Configured by USB Wizard plugin

// USB Device Middle Ware  
#define PDL_USBDEVICECDCCOM_ENABLED                       PDL_ON              //Middleware USB CDC Communication Class
...
#define PDL_USBHOSTHIDCOM_ENABLED                         PDL_ON
#define PDL_USBHOSTHIDKEYBOARD_ENABLED                    PDL_ON
#define PDL_USBHOSTHIDMOUSE_ENABLED                       PDL_ON
#define PDL_USBHOSTMASSSTORAGE_ENABLED                    PDL_ON
...
// USB
#define PDL_INTERRUPT_ENABLE_USB0_DEVICE                  PDL_ON              //Configured by USB Wizard plugin
#define PDL_INTERRUPT_ENABLE_USB0_HOST                    PDL_ON              //Configured by USB Wizard plugin
#define PDL_INTERRUPT_ENABLE_USB1_DEVICE                  PDL_ON              //Configured by USB Wizard plugin
#define PDL_INTERRUPT_ENABLE_USB1_HOST                    PDL_ON              //Configured by USB Wizard plugin
...
// USB
#define PDL_IRQ_LEVEL_USB0                                3                   //Configured by USB Wizard plugin
#define PDL_IRQ_LEVEL_USB1                                3                   //Configured by USB Wizard plugin
