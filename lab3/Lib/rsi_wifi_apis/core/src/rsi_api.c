...
/* Join Frame */
const uint8   rsi_frameCmdJoin[RSI_BYTES_3] = {0x6A, 0x40, 0x14 };
...
/* Power mode frame */
const uint8   rsi_frameCmdPower[RSI_BYTES_3] = {0x01, 0x40, 0x15 };    
...
const uint8   rsi_frameCmdAntSel[RSI_BYTES_3] = {0x01, 0x40, 0x1B};
/* Sleep timer Frame */
...
const uint8   rsi_frameCmdSocket[RSI_BYTES_3] = {0x88, 0x40, 0x42};    
/* Socket close frame */
...
const uint8   rsi_frameCmdWebServer[RSI_BYTES_3] = {0x1D, 0x44, 0x50};
/* DNS server */
...
const uint8   rsi_frameCmdSnmpTrap[RSI_BYTES_3] = {0x3D, 0x40, 0x86/*0x87*/};
/* IPCONFIG6 for IPV6 */
...
const uint8	  rsi_frameCmdUserStoreCfg[RSI_BYTES_3]     = {0xEB, 0x43, 0x23};
