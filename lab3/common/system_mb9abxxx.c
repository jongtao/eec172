 ...
 ** 2013-06-18  0.3  MWi  PDL clock functions for PDL initialization added
 ** 2013-07-05  0.4  MWi  PDL settings removed
 ** 2013-08-23  0.5  EZ   Add FPU setting
 ** 2014-01-15  0.8  EZ   Add the Flash trace buffer enable setting
 ** 2014-05-26  0.9  EZ   Add the Low-speed CR precaler setting
 ******************************************************************************/
...
void SystemCoreClockUpdate (void) {
  ...
  //   "Unordered accesses to a volatile location"
      u32RegisterRead = (__CLKMO  * (((uint32_t)(FM4_CRG->PLL_CTL2) & 0x1Fu) + 1u));
...
// FPU settings 
  ...
  FM4_FLASH_IF->FBFCR = 0x01u;                    /* Trace Buffer enable */
  while(0x02u != (FM4_FLASH_IF->FBFCR & 0x02u))    /* Wait for trace Buffer enable */
  {}
#endif
  ...
  FM4_LCR->LCR_PRSLD = (uint8_t)LCR_PRSLD_Val;               /* set Low-speed CR prescaler */
