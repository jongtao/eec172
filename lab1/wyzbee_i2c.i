#line 1 "WyzBee_i2c\\WyzBee_i2c.c"
...
err_t WyzBeeI2c_Init( WyzBeeI2c_Config_t    *p_config )
{
	...
	stc_mfs_i2c_config_t  config_internal; 								
	...
	if(p_config  !=  0) 												
	{
		...
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->ADE_f.AN21          = 0u;   							
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->ADE_f.AN22          = 0u;   							
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0_f.P06          = 1u;   							
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0_f.P07          = 1u;   							
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08              = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 | 0x05000000; 	

		(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))); 						 	
																		 
		retval = Mfs_I2c_Init(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), (stc_mfs_i2c_config_t *)&config_internal);

		if(retval == Ok)
		{
			Mfs_SetTxIntCallBack (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , (mfs_tx_cb_func_ptr_t)WyzBeeI2c_TxIsr   );	
			Mfs_SetRxIntCallBack (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , (mfs_tx_cb_func_ptr_t)WyzBeeI2c_RxIsr   );	
			Mfs_SetStsIntCallBack(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , (mfs_tx_cb_func_ptr_t)WyzBeeI2c_SatusIsr);	
			Mfs_InitTxIrq(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));								
			Mfs_InitRxIrq(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));								
			I2cStatus = I2cStateStandby;								
		}
		else
		{
			((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->ADE_f.AN21  = 1u;   								
			((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->ADE_f.AN22  = 1u;   								
			((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0_f.P06  = 0u;   								
			((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0_f.P07  = 0u;									
			((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08      = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 & ~(0x05000000);	
						...
						uint16_t   buf_len)
{
	...
	if( (p_buf != 0) && (buf_len != 0u) )  
	{
		GlobalBuf     =  p_buf;
		GlobalBufLen  =  buf_len;
		TxBufIndex    =  0;
		I2cStatus     =  I2cStateTransmitting;							

		Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), (uint16_t)(((uint8_t)slave_addr << 1) | I2cWrite));

		unIBCR.u8IBCR           =  Mfs_GetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));			
		unIBCR.stcIBCR.MSS      =  1u;								
		unIBCR.stcIBCR.ACKE     =  1u;								
		unIBCR.stcIBCR.INTE     =  1u;								
		unIBCR.stcIBCR.ACT_SCC  =  0u;								
		unIBCR.stcIBCR.WSEL     =  0u;								

		Mfs_SetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unIBCR.u8IBCR);						

		unSMR.u8SMR             =  Mfs_GetSMR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));			
		unSMR.stcSMR.TIE        =  1u;								

		Mfs_SetSMR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unSMR.u8SMR);							

		retval = WyzBeeI2cWaitTxRxComplete();							
					 ...
					 uint16_t  *p_buf_len)
{
	...
	RxBufIndex      =  0;
	I2cStatus       =  I2cStateReceiving;								

	Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), (uint16_t)(((uint8_t)slave_addr << 1) | I2cRead));

	unIBCR.u8IBCR          =  Mfs_GetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));				
	unIBCR.stcIBCR.ACKE    =  1u;										
	unIBCR.stcIBCR.WSEL    =  1u;										
	unIBCR.stcIBCR.INTE    =  1u;										
	unIBCR.stcIBCR.ACT_SCC =  0u;									
	unIBCR.stcIBCR.INT     =  0u;									
	unIBCR.stcIBCR.MSS     =  1u;  									
	Mfs_SetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unIBCR.u8IBCR);
...
static void WyzBeeI2c_TxIsr(void)
{
	...
	unIBSR.u8IBSR = Mfs_GetESCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));
	unIBCR.u8IBCR = Mfs_GetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));

	if (1u == unIBSR.stcIBSR.SPC) 									
	{
		unIBSR.stcIBSR.SPC     = 0u; 								
		Mfs_SetESCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , unIBSR.u8IBSR);

		unIBCR.stcIBCR.CNDE    = 0u; 								
		unIBCR.stcIBCR.ACT_SCC = 0u;
		Mfs_SetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unIBCR.u8IBCR);


		unISMK.u8ISMK          = Mfs_GetISMK(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))); 			
		unISMK.stcISMK.EN      = 0u;
		Mfs_SetISMK(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) ,unISMK.u8ISMK);

		unISMK.stcISMK.EN      = 1u; 									
		Mfs_SetISMK(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , unISMK.u8ISMK);

		I2cStatus = I2cStateStandby; 									
	}
	else if (((GlobalBufLen == TxBufIndex)
			&&        (1u == unIBCR.stcIBCR.INT))
			||        (1u == unIBSR.stcIBSR.RACK))
	{

		unIBCR.stcIBCR.MSS     = 0u; 								
		unIBCR.stcIBCR.ACT_SCC = 0u;
		unIBCR.stcIBCR.INTE    = 0u; 								
		unIBCR.stcIBCR.INT     = 0u;   								
		unIBCR.stcIBCR.CNDE    = 1u; 									
		Mfs_SetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , unIBCR.u8IBCR);
	}
	else
	{
		unSSR.u8SSR            = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), 0xFF);
		if (1u == unSSR.stcSSR.TDRE)
		{																
			Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), (uint16_t)GlobalBuf[TxBufIndex]);
			TxBufIndex++;
			if (GlobalBufLen == TxBufIndex) 							
			{
				unSMR.u8SMR      = Mfs_GetSMR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))); 			
				unSMR.stcSMR.TIE = 0u;
				Mfs_SetSMR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , unSMR.u8SMR);
...
static void WyzBeeI2c_RxIsr(void)
{
	...
	else if ((1u == unSSR.stcSSR.RDRF) && (0u == unIBSR.stcIBSR.FBT))
	{
		while (RxBufIndex < GlobalBufLen) 								
		{
			unSSR.u8SSR = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), 0xFF);
			if (1u == unSSR.stcSSR.RDRF)
			{
				GlobalBuf[RxBufIndex] = (uint8_t)Mfs_ReadData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));
				RxBufIndex++;
			}
			else
			{
		...
		if (RxBufIndex == GlobalBufLen) 								
		{
			unIBCR.stcIBCR.MSS  = 0u; 								
			unIBCR.stcIBCR.ACKE = 0u; 								
			unIBCR.stcIBCR.CNDE = 1u; 								
			unIBSR.u8IBSR = Mfs_GetESCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))));
			if (1u == unIBSR.stcIBSR.RSC) 							
			{
				unIBSR.stcIBSR.RSC = 0u; 							
				Mfs_SetESCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unIBSR.u8IBSR);
			}
		}
	}
	if (1u == unSSR.stcSSR.ORE) 										
	{
		Mfs_ErrorClear(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))); 									
	}
	unIBCR.stcIBCR.ACT_SCC = 0u; 									
	unIBCR.stcIBCR.INT = 0u;
	Mfs_SetSCR(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))), unIBCR.u8IBCR);
...
static void WyzBeeI2c_SatusIsr(void)
{
	if (I2cStateTransmitting == I2cStatus) 								
	{
		WyzBeeI2c_TxIsr();
	}
	else 																
