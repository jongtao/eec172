...
#line 583 ".\\lib\\inc\\mfs.h"

#line 591 ".\\lib\\inc\\mfs.h"
...
#line 704 ".\\lib\\inc\\mfs.h"

 
#line 713 ".\\lib\\inc\\mfs.h"

 


 
#line 737 ".\\lib\\inc\\mfs.h"

 
#line 755 ".\\lib\\inc\\mfs.h"

 
#line 773 ".\\lib\\inc\\mfs.h"
...
{
#line 810 ".\\lib\\inc\\mfs.h"
    MfsInstanceIndexMfs4,
#line 819 ".\\lib\\inc\\mfs.h"
    MfsInstanceIndexMfs7,
#line 845 ".\\lib\\inc\\mfs.h"
    MfsInstanceIndexMax
...
{
    MfsHlExecStby          = 0, 
    MfsHlExecReceiving     = 1, 
    MfsHlExecTransmitting  = 2, 
    MfsHlExecWaitTxBusIdle = 3  
} en_mfs_hl_exec_t;
...
{
    MfsHlModeStby                  = 0x00,      
    MfsHlModeUartNormal            = 0x10,      
    MfsHlModeUartMulti             = 0x11,      
    MfsHlModeCsioNormalMaster      = 0x20,      
    MfsHlModeCsioNormalMasterTimer = 0x21,      
    MfsHlModeCsioNormalSlave       = 0x22,      
    MfsHlModeCsioNormalSlaveTimer  = 0x23,      
    MfsHlModeCsioSpiMaster         = 0x28,      
    MfsHlModeCsioSpiMasterWithCs   = 0x29,      
    MfsHlModeCsioSpiSlave          = 0x2A,      
    MfsHlModeCsioSpiSlaveWithCs    = 0x2B,      
    MfsHlModeI2cMaster             = 0x30,      
    MfsHlModeI2cSlave              = 0x31,      
    MfsHlModeI2cMasterFast         = 0x32,      
    MfsHlModeI2cSlaveFast          = 0x33,      
    MfsHlModeLinMaster             = 0x40,      
    MfsHlModeLinSlave              = 0x41       
...
{
    MfsHlI2cWaitAfterAck      = 0,  
    MfsHlI2cWaitAfterDataTxRx = 1   
...
{
    MfsHlI2cIntStateStby     = 0,       
    MfsHlI2cIntStateEndData  = 1,       
    MfsHlI2cIntStateNack     = 2,       
    MfsHlI2cIntStateStopCond = 3,       
    MfsHlI2cIntStateErr      = 0xEE     
...
typedef struct stc_mfs_hl_buffer
{
    ...
    uint16_t  u16InIndex;       
    uint16_t  u16OutIndex;      
    uint16_t  u16FillCount;     
...
typedef struct stc_mfs_hl_uart_config
{
    ...
    uint8_t*                pu8TxBuf;           
    uint8_t*                pu8RxBuf;           
    uint16_t                u16TxBufSize;       
    uint16_t                u16RxBufSize;       
    uint16_t                u16RxCbBufFillLvl;  
    uint8_t                 u8UartMode;         
    uint8_t                 u8Parity;           
    uint8_t                 u8StopBit;          
    uint8_t                 u8CharLength;       
    uint8_t                 u8FifoUsage;        
    mfs_hl_rx_cb_func_ptr_t pfnRxCb;            
    mfs_hl_tx_cb_func_ptr_t pfnTxCb;            
...
typedef struct stc_mfs_hl_spi_config
{
    ...
    uint16_t  u16CsDeSelect;    
    uint8_t   u8CsSetDelay;     
    uint8_t   u8CsHoldDelay;    
    uint8_t   u8CsDivision;     
...
typedef struct stc_mfs_hl_csio_config
{
    ...
    boolean_t                  bBitDirection;       
    boolean_t                  bSignalSystem;       
    stc_mfs_hl_spi_config_t*   pstcMfsSpiCsConfig;  
    stc_mfs_hl_timer_config_t* pstcMfsTimerConfig;  
    uint8_t*                   pu8TxBuf;            
    uint8_t*                   pu8RxBuf;            
    uint16_t                   u16TxBufSize;        
    uint16_t                   u16RxBufSize;        
...
typedef struct stc_mfs_hl_i2c_config
{
    ...
    mfs_hl_rx_cb_func_ptr_t      pfnRxCb;       
    mfs_hl_tx_cb_func_ptr_t      pfnTxCb;       
    mfs_hl_i2c_slv_cb_func_prt_t pfnI2cSlvStCb; 
...
typedef struct stc_mfs_hl_lin_config
{
    ...
    mfs_hl_rx_cb_func_ptr_t   pfnRxCb;            
    mfs_hl_tx_cb_func_ptr_t   pfnTxCb;            
    mfs_hl_lin_brk_func_ptr_t pfnLinBrkCb;        
...
{
    mfs_hl_tx_cb_func_ptr_t      pfnTransmitCbFunction;     
    mfs_hl_rx_cb_func_ptr_t      pfnReceiveCbFunction;      
    mfs_hl_i2c_slv_cb_func_prt_t pfnI2cSlvStCbFunction;     
    mfs_hl_lin_brk_func_ptr_t    pfnLinBreakCbFunction;     
    stc_mfs_hl_buffer_t          stcRxBuffer;               
    stc_mfs_hl_buffer_t          stcTxBuffer;               
    uint32_t                     u32I2cProcCnt;             
    uint16_t                     u16RxCallbackBufFillLevel; 
    uint8_t                      u8FifoUsage;               
    uint8_t                      u8MfsMode;                 
    uint8_t                      u8Exec;                    
    uint8_t                      u8DataWidth;               
...
{
    volatile stc_mfsn_t*     pstcInstance;  
    stc_mfs_hl_intern_data_t stcInternData; 
...
#line 89 "lib\\src\\mfs_hl.c"

 
#line 103 "lib\\src\\mfs_hl.c"

#line 110 "lib\\src\\mfs_hl.c"
...
static stc_mfs_hl_intern_data_t* MfsHlGetInternDataPtr(volatile stc_mfsn_t* pstcMfs)
{
    stc_mfs_hl_intern_data_t* pstcMfsInternDataPtr = 0;
                         ...
                         )
{
    ...
    while (0u != fu16Loop)
    {
        ...
        {
            u32Data <<= (8u);
            u32Data |= (uint32_t)(pstcBuffer->pu8Buffer[pstcBuffer->u16OutIndex]) & (0x000000FFu);
             
            pstcBuffer->u16OutIndex = ((pstcBuffer->u16OutIndex + (uint16_t)(1u)) % (pstcBuffer->u16BufferSize));
                             ...
                             )
{
    ...
    if (MfsHlExecWaitTxBusIdle == pstcMfsHlInternData->u8Exec)
    {
        ...
        pstcMfs->SCR_f.TBIE = ((boolean_t) 0);
         
        pstcMfs->SCR_f.TXE = ((boolean_t) 0);
        pstcMfs->SACSR_f.TMRE = ((boolean_t) 0);
        pstcMfs->SCR_f.TXE = ((boolean_t) 1);
        if (0 != pstcMfsHlInternData->pfnTransmitCbFunction)
        {
    ...
    else
    {
        ...
        if (((boolean_t) 1) == u8End)
        {
             
            if (MfsHlUseFifo == pstcMfsHlInternData->u8FifoUsage)
            {
                 
                pstcMfs->FCR1_f.FTIE = ((boolean_t) 0);
            }
            else
            {
                 
                pstcMfs->SCR_f.TIE = ((boolean_t) 0); 
            }
            ...
            if (0u == pstcBuffer->u16TxCount)
            {
                ...
                if (MfsHlModeCsioNormalMasterTimer == pstcMfsHlInternData->u8MfsMode)
                {
                    ...
                    pstcMfs->SCR_f.TBIE = ((boolean_t) 1);
                }
                else
                {
                    if (0 != pstcMfsHlInternData->pfnTransmitCbFunction)
    ...
    if (MfsHlUseFifo == pstcMfsHlInternData->u8FifoUsage)
    {
        ...
        while (0u != pstcMfs->FBYTE2)
        {
            ...
            else
            {
                ...
                pstcRxBuffer->bOverflow = ((boolean_t) 1);
            }
        }
    }
    else
                             ...
                             )
{
    ...
    switch (pstcMfsHlInternData->u8MfsMode & (0xF0u))
    {
    ...
    if(0u != u8Ssr)
    {
        ...
        pstcMfs->SSR_f.REC = ((boolean_t) 1);
    }

     
    MfsHlReadBuf(pstcMfs, pstcMfsHlInternData);
     
    if (0 != pstcMfsHlInternData->pfnReceiveCbFunction)
    {
                              ...
                              )
{
    ...
    if ((pstcMfs->SMR & (0xE0u)) == (0x60u))
    {
         
        if (pstcMfs->SSR_f.LBD == 1)
        {
            u16DummyData = pstcMfs->RDR;
            pstcMfs->SSR_f.LBD = ((boolean_t) 0);  
            pstcMfs->SSR_f.REC = ((boolean_t) 1);   
            
             
            if (0 != pstcMfsHlInternData->pfnLinBreakCbFunction)
            {
...
{
    stc_mfs_fcr0_field_t stcFCR0 = { 0 };  
    ...
    stcFCR0.FLD  = ((boolean_t) 0);     
    stcFCR0.FSET = ((boolean_t) 0);     
    stcFCR0.FCL2 = ((boolean_t) 1);      
    stcFCR0.FCL1 = ((boolean_t) 1);      
    stcFCR0.FE2  = ((boolean_t) 1);      
    stcFCR0.FE1  = ((boolean_t) 1);      
    ...
    stcFCR1.FTST0 = ((boolean_t) 0);
    stcFCR1.FTST1 = ((boolean_t) 0);

    stcFCR1.FLSTE = ((boolean_t) 0);    
    stcFCR1.FRIIE = ((boolean_t) 0);    
    stcFCR1.FDRQ  = ((boolean_t) 0);    
    stcFCR1.FTIE  = ((boolean_t) 0);    
    stcFCR1.FSEL  = ((boolean_t) 0);    

     
    pstcMfs->FCR0_f  = stcFCR0;
    pstcMfs->FCR1_f  = stcFCR1;
    pstcMfs->FBYTE2  = (uint8_t)MfsHlGetMin(u16BufFillLvl, (16u));
}  
                                ...
                                )
{
    ...
    if (((boolean_t) 1) == stcIBSR.SPC)
    {
         
        stcIBSR.SPC = ((boolean_t) 0);
        pstcI2c->IBSR_f = stcIBSR;

         
        stcIBCR.CNDE = ((boolean_t) 0);
        stcIBCR.ACT_SCC = ((boolean_t) 0);
        pstcI2c->IBCR_f = stcIBCR;

         
        stcISMK = pstcI2c->ISMK_f;
        stcISMK.EN       = ((boolean_t) 0);
        pstcI2c->ISMK_f = stcISMK;

         
        stcISMK.EN       = ((boolean_t) 1);
        pstcI2c->ISMK_f = stcISMK;
    ...
    &&        (((boolean_t) 1) == stcIBCR.INT))
    ||        (((boolean_t) 1) == stcIBSR.RACK))
    {
         
        stcIBCR.MSS  = ((boolean_t) 0);
        stcIBCR.ACT_SCC = ((boolean_t) 0);
         
        stcIBCR.INTE = ((boolean_t) 0);
         
        stcIBCR.INT  = ((boolean_t) 0);
         
        stcIBCR.CNDE = ((boolean_t) 1);
        pstcI2c->IBCR_f = stcIBCR;
    }
    else
    {
                                ...
                                )
{
    ...
    else if ((((boolean_t) 1) == stcSSR.RDRF) && (((boolean_t) 0) == stcIBSR.FBT))
    {
        ...
        if (pstcBuffer->u16InIndex == pstcBuffer->u16BufferSize)
        {
            ...
            stcIBCR.ACKE = ((boolean_t) 0);
             
            stcIBCR.CNDE = ((boolean_t) 1);

             
            if (((boolean_t) 1) == stcIBSR.RSC)
            {
                 
                stcIBSR.RSC = ((boolean_t) 0);
                pstcI2c->IBSR_f = stcIBSR;
            }
        }
    }
     
    else if (((boolean_t) 1) == stcSSR.ORE)
    {
         
        stcSSR.REC = ((boolean_t) 1);
                                 ...
                                 )
{
    ...
    if ((((boolean_t) 0) == stcIBCR.MSS) && (((boolean_t) 1) == stcIBCR.ACT_SCC) && (((boolean_t) 1) == stcIBSR.FBT))
    {
        stcSMR = pstcI2c->SMR_f;
         
         
        if (((boolean_t) 1) == stcIBSR.TRX)
        {
             
            if (0 != pstcMfsHlInternData->pfnI2cSlvStCbFunction)
            {
            ...
            stcSMR.TIE = ((boolean_t) 0);
            stcIBCR.WSEL = ((boolean_t) 0);
        }
         
        else
        {
            stcIBCR.ACKE = ((boolean_t) 1);
             
            stcSMR.RIE = ((boolean_t) 0);
            stcIBCR.WSEL = ((boolean_t) 1);
                               ...
                               )
{
    ...
    else if (((boolean_t) 1) == stcIBSR.RACK)
    {
    ...
    else
    {
        ...
        if ((((boolean_t) 1) == stcSSR.RDRF) && (((boolean_t) 0) == stcIBSR.FBT))
        {
                            ...
                            )
{
    ...
    if ((4u) > u32ReloadValue)
    {
        return (ErrorInvalidParameter);
    }

     
    if (((0 == pstcConfig->pu8TxBuf)
    ||   (0u == pstcConfig->u16TxBufSize))
    ||  ((0 == pstcConfig->pu8RxBuf)
    ...
    pstcUart->SCR_f.UPCL = ((boolean_t) 1);
    ...
    if (((boolean_t) 1) == pstcConfig->bBitDirection)
    {
        stcSMR.BDS = ((boolean_t) 1);
    }
    else
    {
        stcSMR.BDS = ((boolean_t) 0);
    }
    ...
    switch (pstcConfig->u8StopBit)
    {
        ...
        case MfsThreeStopBits:
            stcSMR.SBL = ((boolean_t) 0);
            break;
        case MfsTwoStopBits:
        case MfsFourStopBits:
            stcSMR.SBL = ((boolean_t) 1);
            break;
        default:
            return (ErrorInvalidParameter);
    }
    ...
    if (MfsUartNormal == pstcConfig->u8UartMode)
    {
        ...
        {
            case MfsParityNone:
                stcESCR.P   = ((boolean_t) 0);  
                stcESCR.PEN = ((boolean_t) 0);  
                break;
            case MfsParityEven:
                stcESCR.P   = ((boolean_t) 0);  
                stcESCR.PEN = ((boolean_t) 1);   
                break;
            case MfsParityOdd:
                stcESCR.P   = ((boolean_t) 1);   
                stcESCR.PEN = ((boolean_t) 1);   
                break;
            default:
                return (ErrorInvalidParameter);  
    ...
    switch (pstcConfig->u8StopBit)
    {
        case MfsOneStopBit:
        case MfsTwoStopBits:
            stcESCR.ESBL = ((boolean_t) 0);
            break;
        case MfsThreeStopBits:
        case MfsFourStopBits:
            stcESCR.ESBL = ((boolean_t) 1);
            break;
        default:
            return (ErrorInvalidParameter);
    }
    ...
    if (((boolean_t) 1) == pstcConfig->bHwFlow)
    {
        stcESCR.FLWEN = ((boolean_t) 1);
    }
    else
    {
        stcESCR.FLWEN = ((boolean_t) 0);
    }

     
    if (((boolean_t) 1) == pstcConfig->bSignalSystem)
    {
        stcESCR.INV = ((boolean_t) 1);
    }
    else
    {
        stcESCR.INV = ((boolean_t) 0);
    }
    ...
    pstcUart->SSR_f.REC = ((boolean_t) 1);
    ...
    pstcUart->BGR = (uint16_t)(u32ReloadValue & (0x7FFFu));
    ...
    pstcMfsHlInternData->stcTxBuffer.u16InIndex    = 0u;  
    pstcMfsHlInternData->stcTxBuffer.u16OutIndex   = 0u;  
    pstcMfsHlInternData->stcTxBuffer.u16FillCount  = 0u;  
    pstcMfsHlInternData->stcTxBuffer.u16TxCounter  = 0u;  
    pstcMfsHlInternData->stcTxBuffer.u16TxCount    = 0u;  
    pstcMfsHlInternData->stcTxBuffer.bOverflow     = 0u;  
    ...
    pstcMfsHlInternData->stcRxBuffer.u16InIndex    = 0u;  
    pstcMfsHlInternData->stcRxBuffer.u16OutIndex   = 0u;  
    pstcMfsHlInternData->stcRxBuffer.u16FillCount  = 0u;  
    pstcMfsHlInternData->stcRxBuffer.bOverflow     = 0u;  
    ...
    pstcUart->SCR_f.TXE = ((boolean_t) 1);
    pstcUart->SCR_f.RXE = ((boolean_t) 1);

     
    if (0 != pstcConfig->pfnRxCb)
    {
         
        pstcUart->SCR_f.RIE = ((boolean_t) 1);
    }
...
en_result_t Mfs_Hl_Uart_DeInit(volatile stc_mfsn_t* pstcUart)
{
    ...
    else
    {
        ...
        pstcUart->SCR_f.TXE = ((boolean_t) 0);
        pstcUart->SCR_f.RXE = ((boolean_t) 0);

        (void)Mfs_DeInitIrq(pstcUart);      
        ...
        (void)Mfs_SetTxIntCallBack(pstcUart, 0);
        (void)Mfs_SetRxIntCallBack(pstcUart, 0);
        (void)Mfs_SetStsIntCallBack(pstcUart, 0);
        (void)Mfs_SetUpperLayerHandle(pstcUart, 0);

         
        pstcMfsHlInternData->stcTxBuffer.pu8Buffer  = 0;
        pstcMfsHlInternData->stcRxBuffer.pu8Buffer  = 0;

         
        pstcMfsHlInternData->pfnTransmitCbFunction = 0;
        pstcMfsHlInternData->pfnReceiveCbFunction  = 0;

         
        pstcMfsHlInternData->pfnLinBreakCbFunction = 0;
        pstcMfsHlInternData->u8Exec = MfsHlExecStby;
                            ...
                            )
{
    ...
    pstcCsio->SCR_f.UPCL = ((boolean_t) 1);
    ...
    switch (pstcConfig->u8CsioMode)
    {
        ...
        case MfsCsioMaster:
            stcSCR.MS = ((boolean_t) 0);
            break;
         
        case MfsCsioSlave:
            stcSCR.MS = ((boolean_t) 1);
            break;
        default:
            return (ErrorInvalidParameter);  
    }
    ...
    switch (pstcConfig->u8CsioActMode)
    {
        ...
        case MfsCsioActNormalMode:
            stcSCR.SPI = ((boolean_t) 0);
            break;
         
        case MfsCsioActSpiMode:
            stcSCR.SPI = ((boolean_t) 1);
            break;
        default:
            return (ErrorInvalidParameter);  
    }
    ...
    if (MfsCsioMaster == pstcConfig->u8CsioMode)
    {
        ...
        stcSMR.SCKE = ((boolean_t) 1);
    }
    else
    {
         
        stcSMR.SCKE = ((boolean_t) 0);
    }
    ...
    if (((boolean_t) 1) == pstcConfig->bSignalSystem)
    {
        ...
        stcSMR.SCINV = ((boolean_t) 1);
    }
    else
    {
         
        stcSMR.SCINV = ((boolean_t) 0);
    }
    ...
    stcESCR.SOP = ((boolean_t) 0);

    stcESCR.L3 = ((boolean_t) 0);   
    stcSSR.AWC = ((boolean_t) 0);   
    ...
    pstcCsio->SSR_f.REC = ((boolean_t) 1);
    ...
    if (0 != pstcConfig->pstcMfsSpiCsConfig)
    {
         
        if ((MfsCsioActSpiMode == pstcConfig->u8CsioActMode)
         
        && ((pstcCsio == &(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL)))) || (pstcCsio == &(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))))
           )
        {
             
            stcSCSCR.CSEN0 = ((boolean_t) 1);
            if (MfsCsioMaster == pstcConfig->u8CsioMode)
            {
                 
                stcSCSCR.CSOE = ((boolean_t) 1);
                 
                stcSCSCR.CDIV = pstcConfig->pstcMfsSpiCsConfig->u8CsDivision & (0x07u);
            ...
            else
            {
                ...
                if (((boolean_t) 0) == pstcConfig->pstcMfsSpiCsConfig->bCsLevel)
                {
                     
                    stcSCSCR.CSLVL = ((boolean_t) 1);
                }
    ...
    else if (0 != pstcConfig->pstcMfsTimerConfig)
    {
        ...
        &&  (MfsCsioMaster == pstcConfig->u8CsioMode))
        {
            ...
            stcSACSR.TDIV = pstcConfig->pstcMfsTimerConfig->u8TimerDivision & (0x0Fu);
             
            if (((boolean_t) 1) == pstcConfig->pstcMfsTimerConfig->bTimerSyncEnable)
            {
                 
                stcSACSR.TSYNE = ((boolean_t) 1);
    ...
    pstcCsio->BGR = (uint16_t)(u32ReloadValue & (0x7FFFu));
    ...
    pstcCsio->SCR_f.TXE = ((boolean_t) 1);
    pstcCsio->SCR_f.RXE = ((boolean_t) 1);

     
    if (0 != pstcConfig->pfnRxCb)
    {
         
        pstcCsio->SCR_f.RIE = ((boolean_t) 1);
    }
...
en_result_t Mfs_Hl_Csio_DeInit(volatile stc_mfsn_t* pstcCsio)
{
    ...
    else
    {
        ...
        pstcCsio->SCR_f.TXE = ((boolean_t) 0);
        pstcCsio->SCR_f.RXE = ((boolean_t) 0);
    
        (void)Mfs_DeInitIrq(pstcCsio);      
        ...
        (void)Mfs_SetTxIntCallBack(pstcCsio, 0);
        (void)Mfs_SetRxIntCallBack(pstcCsio, 0);
        (void)Mfs_SetStsIntCallBack(pstcCsio, 0);
        (void)Mfs_SetUpperLayerHandle(pstcCsio, 0);
                                        ...
                                        )
{
    ...
    switch (pstcMfsHlInternData->u8MfsMode)
    {
        ...
        case MfsHlModeCsioSpiMasterWithCs:
            ...
            if (((boolean_t) 1) == bCsHolding)
            {
                 
                pstcCsio->SCSCR_f.SCAM = ((boolean_t) 1);
            }
            else
            {
                 
                pstcCsio->SCSCR_f.SCAM = ((boolean_t) 0);
            }
            pstcCsio->SCR_f.TXE = ((boolean_t) 1);
            break;
        ...
        case MfsHlModeCsioNormalMasterTimer:
            ...
            pstcCsio->SCR_f.TXE = ((boolean_t) 0);
            pstcCsio->SACSR_f.TMRE = ((boolean_t) 1);
            pstcCsio->SCR_f.TXE = ((boolean_t) 1);
            break;
    ...
    if (0 != pstcMfsHlInternData->pfnReceiveCbFunction)
    {
        ...
        pstcCsio->SCR_f.RIE = ((boolean_t) 0);
    }
    ...
    while (u16DataReceivedCounter != u16TransferSize)
    {
        if (u16DataToSendCounter < u16TransferSize)
        {
            ...
            while(((boolean_t) 0) == pstcCsio->SSR_f.TDRE)
            {
                PDL_WAIT_LOOP_HOOK();
            }
        ...
        if (((1u) == u16DataToSendCounter) && ((1u) < u16TransferSize))
        {
    ...
    if (MfsHlModeCsioNormalMasterTimer == pstcMfsHlInternData->u8MfsMode)
    {
        ...
        while (((boolean_t) 0) == pstcCsio->SSR_f.TBI)
        {
             
            pstcCsio->SCR_f.TXE    = ((boolean_t) 0);
            pstcCsio->SACSR_f.TMRE = ((boolean_t) 0);
            pstcCsio->SCR_f.TXE    = ((boolean_t) 1);
        }
    }
                           ...
                           )
{
    ...
    pstcLin->SCR_f.UPCL = ((boolean_t) 1);
    ...
    if (((boolean_t) 1) == pstcConfig->bLinBreakIrqEnable)
    {
        stcESCR.LBIE = ((boolean_t) 1);
    }
    else
    {
        stcESCR.LBIE = ((boolean_t) 0);
    }
    ...
    if (MfsHlUseFifo == pstcMfsHlInternData->u8FifoUsage)
    {
        ...
        MfsHlFifoUseInit(pstcLin, (1u));
    }

     
    pstcMfsHlInternData->u16RxCallbackBufFillLevel = (1u);

     
    pstcMfsHlInternData->u8DataWidth = MfsEightBits;

     
    pstcLin->BGR = (uint16_t)(u32ReloadValue & (0x7FFFu));
    ...
    pstcLin->SCR_f.TXE = ((boolean_t) 1);
    pstcLin->SCR_f.RXE = ((boolean_t) 1);

     
    if (0 != pstcConfig->pfnRxCb)
    {
         
        pstcLin->SCR_f.RIE = ((boolean_t) 1);
    }
...
en_result_t Mfs_Hl_Lin_SetBreak(volatile stc_mfsn_t* pstcLin)
{
    ...
    else if (((0x60u) != (pstcLin->SMR & (0xE0u)))
    ||       (((boolean_t) 1) == pstcLin->SCR_f.MS) )
    {
        enResult = ErrorInvalidMode;
    }

     
    else if (((boolean_t) 0) == pstcLin->SSR_f.TBI)
    {
                           ...
                           )
{
    ...
    if ((pstcI2c == (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38300UL)))))
    ||  (pstcI2c == (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL)))))
       )
    {
        switch (pstcConfig->u8FastMode)
        {
            ...
            case MfsI2cDisableFastModePlus:
                if (pstcI2c == (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38300UL)))))
                {
                    ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR16_f.SFMPAC = ((boolean_t) 0);
                }
                else
                {
                    ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR16_f.SFMPBC = ((boolean_t) 0);
                }
                break;
            ...
            case MfsI2cEnableFastModePlus:
                if (pstcI2c == (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38300UL)))))
                {
                    ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR16_f.SFMPAC = ((boolean_t) 1);
                }
                else
                {
                    ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR16_f.SFMPBC = ((boolean_t) 1);
                }
                break;
            default:
                return (ErrorInvalidParameter);  
    ...
    if (MfsI2cSlave == pstcConfig->u8I2cMode)
    {
        ...
        stcIBCR.INTE = ((boolean_t) 1);
         
        stcISBA.SA = pstcConfig->u8SlvAddr;
         
        stcISBA.SAEN = ((boolean_t) 1);
    }
    ...
    if (MfsI2cMaster == pstcConfig->u8I2cMode)
    {
        ...
        pstcMfsHlInternData->pfnI2cSlvStCbFunction = 0;
    }
    else
    {
    ...
    pstcI2c->BGR = (uint16_t)(u32ReloadValue & (0x7FFFu));
...
en_result_t Mfs_Hl_I2c_DeInit(volatile stc_mfsn_t* pstcI2c)
{
    ...
    else
    {
        ...
        pstcI2c->ISMK_f.EN = ((boolean_t) 0);

        (void)Mfs_DeInitIrq(pstcI2c);      
        ...
        (void)Mfs_SetTxIntCallBack(pstcI2c, 0);
        (void)Mfs_SetRxIntCallBack(pstcI2c, 0);
        (void)Mfs_SetStsIntCallBack(pstcI2c, 0);
        (void)Mfs_SetUpperLayerHandle(pstcI2c, 0);
                                     ...
                                     )
{
    ...
    if ((((boolean_t) 1) == stcIBCR.ACT_SCC) && (((boolean_t) 0) == stcIBCR.MSS))
    {
                        ...
                        )
{
    ...
    if (MfsHlModeCsioNormalMasterTimer == pstcMfsHlInternData->u8MfsMode)
    {
        ...
        pstcMfs->SCR_f.TXE = ((boolean_t) 0);
        pstcMfs->SACSR_f.TMRE = ((boolean_t) 1);
        pstcMfs->SCR_f.TXE = ((boolean_t) 1);
    }
    ...
    while (0u < u16WriteCnt)
    {
        ...
        if (MfsHlModeCsioSpiMasterWithCs == pstcMfsHlInternData->u8MfsMode)
        {
            ...
            if ((0u != u16WriteCnt) || (((boolean_t) 1) == bCsHolding))
            {
                 
                pstcMfs->SCSCR_f.SCAM = ((boolean_t) 1);
            }
            else
            {
                 
                pstcMfs->SCSCR_f.SCAM = ((boolean_t) 0);
            }
            pstcMfs->SCR_f.TXE = ((boolean_t) 1);
        }
        ...
        if (0 != pstcMfsHlInternData->pfnTransmitCbFunction)
        {
            if (MfsHlUseFifo == pstcMfsHlInternData->u8FifoUsage)
            {
                ...
                pstcMfs->FCR1_f.FTIE = ((boolean_t) 1);
            }
            else  
            {
                 
                pstcMfs->SCR_f.TIE = ((boolean_t) 1);
            }
        }
        ...
        else
        {
            ...
            while (0u != pstcBuffer->u16FillCount)
            {
                ...
                if (((boolean_t) 1) == pstcMfs->SSR_f.TDRE)
                {
            ...
            if (0u == u16WriteCnt)
            {
                ...
                if (MfsHlModeCsioNormalMasterTimer == pstcMfsHlInternData->u8MfsMode)
                {
                    ...
                    while (((boolean_t) 0) == pstcMfs->SSR_f.TBI)
                    {
                       ...
                       )
{
    ...
    if (0 != pstcMfsHlInternData->pfnReceiveCbFunction)
    {
        if (((boolean_t) 0) == pstcMfs->SCR_f.RIE)
        {
             
            pstcMfs->SCR_f.RIE = ((boolean_t) 1);
        }
    }
    ...
    while (0u < u16BytesToReadLeft)
    {
        ...
        if (0u != fu16Length)
        {
            ...
            pstcBuffer->u16FillCount -= (uint16_t)fu16Length;  
        }

        *pu16DataCnt       += (uint16_t)fu16Length;  
        u16BytesToReadLeft -= (uint16_t)fu16Length;  

         
        if (MfsHlUseFifo == pstcMfsHlInternData->u8FifoUsage)
        {
            if ((16u) > u16BytesToReadLeft)
            {
