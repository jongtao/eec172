#line 1 "WyzBee_oled\\SPI_OLED.cpp"
...
#line 21 "WyzBee_oled\\SPI_OLED.cpp"
#line 1 ".\\common\\mfs.h"
...
#line 22 "WyzBee_oled\\SPI_OLED.cpp"
...
{
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P51 = ((boolean_t) 0); 
	return ;
}
...
{
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P51 = ((boolean_t) 1);  
	return ;
}
...
unsigned char SPI_OLEDClass::transfer(unsigned char  tx_char) 
{
	...
	do																		 
	{
		u8Reg = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (0x02u));
	} while ((u8Reg & (0x02u))!= (0x02u));
	u16Data =(uint16_t)tx_char;
	Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), u16Data);

	do																		 
	{
		u8Reg = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (0x04u));
	} while ((u8Reg & (0x04u))!= (0x04u));
	u16Data_rx = Mfs_ReadData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));
...
void SPI_OLEDClass::begin(void)
{
	...
	if (Ok != Mfs_Csio_Init(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (stc_mfs_csio_config_t *)&stcMfsCsioCfg_oled))  
	{
		(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 =  ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 | 0x0000001C;			
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08= ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 | 0x00000150; 		
	}
	Mfs_Csio_SetSckOutEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), ((boolean_t) 1)); 				
	Mfs_ErrorClear(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL)))); 						
	Mfs_SetTxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), ((boolean_t) 1)); 			
	Mfs_SetRxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), ((boolean_t) 1)); 			

	
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5_f.P51 = 0u;				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR5_f.P51  = ((boolean_t) 1);			
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P51 = ((boolean_t) 1);			

	
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR4_f.P40 = 0u; 				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR4_f.P40  = ((boolean_t) 1);  			
	return;
}
...
void SPI_OLEDClass::end(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 =  ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 & ~(0x0000001C); 		
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08= ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 & ~(0x00000150); 	
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR5_f.P53  = ((boolean_t) 0); 
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P53 = ((boolean_t) 0); 
	return ;
}
...
void SPI_OLEDClass::setBitOrder(unsigned char bit_order) 
{

	if(0==bit_order)
	{
		stcMfsCsioCfg_oled.bBitDirection=0;  
	}
	else
	{
		stcMfsCsioCfg_oled.bBitDirection=1;  
	}
	(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));
	if (Ok != Mfs_Csio_Init(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (stc_mfs_csio_config_t *)&stcMfsCsioCfg_oled))  
	{
...
void SPI_OLEDClass::setClockDivider(unsigned char div_num) 
{
	switch(div_num)
	{
	case 2:
		stcMfsCsioCfg_oled.u32DataRate=80000000;  
		break;
	case 4:
		stcMfsCsioCfg_oled.u32DataRate=40000000;	
		break;
	case 8:
		stcMfsCsioCfg_oled.u32DataRate=20000000;	
		break;
	case 16:
		stcMfsCsioCfg_oled.u32DataRate=10000000;	
		break;
	case 32:
		stcMfsCsioCfg_oled.u32DataRate=5000000;		
		break;
	default:
		break;
	}
...
void SPI_OLEDClass::setDataMode(unsigned char data_mode) 
{
	return ;
}
