...
#line 83 "lib\\src\\mfs.c"

 
#line 94 "lib\\src\\mfs.c"
...
static stc_mfs_intern_data_t* MfsGetInternDataPtr(volatile stc_mfsn_t* pstcMfs)
{
    stc_mfs_intern_data_t* pstcInternDataPtr = 0;
...
{
#line 274 "lib\\src\\mfs.c"

#line 284 "lib\\src\\mfs.c"

#line 294 "lib\\src\\mfs.c"

#line 304 "lib\\src\\mfs.c"


    if (pstcMfs == &(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))))
    {
         
        NVIC_ClearPendingIRQ(MFS4_TX_IRQn);
        NVIC_EnableIRQ(MFS4_TX_IRQn);
        NVIC_SetPriority(MFS4_TX_IRQn, 15u);
    }


#line 324 "lib\\src\\mfs.c"
...
#line 364 "lib\\src\\mfs.c"

#line 374 "lib\\src\\mfs.c"

#line 384 "lib\\src\\mfs.c"

#line 394 "lib\\src\\mfs.c"

#line 404 "lib\\src\\mfs.c"

#line 414 "lib\\src\\mfs.c"

#line 424 "lib\\src\\mfs.c"
...
{
#line 449 "lib\\src\\mfs.c"

#line 459 "lib\\src\\mfs.c"

#line 469 "lib\\src\\mfs.c"

#line 479 "lib\\src\\mfs.c"
    ...
    if (pstcMfs == &(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))))
    {
        ...
        NVIC_SetPriority(MFS4_RX_IRQn, 15u);
    }


#line 499 "lib\\src\\mfs.c"
...
#line 539 "lib\\src\\mfs.c"

#line 549 "lib\\src\\mfs.c"

#line 559 "lib\\src\\mfs.c"

#line 569 "lib\\src\\mfs.c"

#line 579 "lib\\src\\mfs.c"

#line 589 "lib\\src\\mfs.c"

#line 599 "lib\\src\\mfs.c"
...
{
#line 627 "lib\\src\\mfs.c"

#line 641 "lib\\src\\mfs.c"

#line 655 "lib\\src\\mfs.c"

#line 669 "lib\\src\\mfs.c"
    ...
    if (pstcMfs == &(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))))
    {
        ...
        NVIC_SetPriority(MFS4_TX_IRQn, 0x0Fu);

        NVIC_ClearPendingIRQ(MFS4_RX_IRQn);
        NVIC_DisableIRQ(MFS4_RX_IRQn);
        NVIC_SetPriority(MFS4_RX_IRQn, 0x0Fu);
    }


#line 697 "lib\\src\\mfs.c"
...
#line 753 "lib\\src\\mfs.c"

#line 767 "lib\\src\\mfs.c"

#line 781 "lib\\src\\mfs.c"

#line 795 "lib\\src\\mfs.c"

#line 809 "lib\\src\\mfs.c"

#line 823 "lib\\src\\mfs.c"

#line 837 "lib\\src\\mfs.c"
...
{
    if ((0 != pstcMfs) && (0 != pstcMfsInternData))
    {
        if (0 != pstcMfsInternData->pfnReceiveCbFunction)
        {
                    ...
                    )
{
    if ((0 != pstcMfs) && (0 != pstcMfsInternData))
    {
        if (0 != pstcMfsInternData->pfnTransmitCbFunction)
        {
                        ...
                        )
{
    if ((0 != pstcMfs) && (0 != pstcMfsInternData))
    {
        if (0 != pstcMfsInternData->pfnStatusCbFunction)
        {
                         ...
                         )
{
    ...
    if ((0 == MfsGetInternDataPtr(pstcUart))
    ||  (0 == pstcConfig)
       )
    {
...
en_result_t Mfs_Uart_DeInit(volatile stc_mfsn_t* pstcUart)
{
    ...
    else
    {
        ...
        pstcMfsInternData->pfnTransmitCbFunction = 0;
        pstcMfsInternData->pfnReceiveCbFunction  = 0;
        pstcMfsInternData->pfnStatusCbFunction   = 0;
        pstcMfsInternData->pvUpperLayerHandle    = 0;
                         ...
                         )
{
    ...
    if ((0 == MfsGetInternDataPtr(pstcCsio))
    ||  (0 == pstcConfig)
       )
    {
        return (ErrorInvalidParameter);
                                    ...
                                    )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SMR_f.SCKE = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SMR_f.SCKE = ((boolean_t) 1);
        }
                                           ...
                                           )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SACSR_f.TBEEN = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SACSR_f.TBEEN = ((boolean_t) 1);
        }
                                              ...
                                              )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SACSR_f.CSEIE = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SACSR_f.CSEIE = ((boolean_t) 1);
        }
...
en_result_t Mfs_Csio_ClrChipSelectErr(volatile stc_mfsn_t* pstcCsio)
{
    ...
    else
    {
        ...
        pstcCsio->SACSR_f.CSE = ((boolean_t) 0);
...
en_result_t Mfs_Csio_ClrTimerIntReq(volatile stc_mfsn_t* pstcCsio)
{
    ...
    else
    {
        ...
        pstcCsio->SACSR_f.TINT = ((boolean_t) 0);
                                            ...
                                            )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SACSR_f.TINTE = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SACSR_f.TINTE = ((boolean_t) 1);
        }
                                       ...
                                       )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SACSR_f.TSYNE = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SACSR_f.TSYNE = ((boolean_t) 1);
        }
                                       ...
                                       )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bLevel)
        {
            pstcCsio->SCSCR_f.CSLVL = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SCSCR_f.CSLVL = ((boolean_t) 1);
        }
                                        ...
                                        )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SCSCR_f.CSEN0 = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SCSCR_f.CSEN0 = ((boolean_t) 1);
        }
                                           ...
                                           )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcCsio->SCSCR_f.CSOE = ((boolean_t) 0);
        }
         
        else
        {
            pstcCsio->SCSCR_f.CSOE = ((boolean_t) 1);
        }
                        ...
                        )
{
    ...
    if ((0 == MfsGetInternDataPtr(pstcI2c))
    ||  (0 == pstcConfig)
       )
    {
        return (ErrorInvalidParameter);
                                  ...
                                  )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->SMR_f.TIE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->SMR_f.TIE = ((boolean_t) 1);
        }
                                  ...
                                  )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->SMR_f.RIE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->SMR_f.RIE = ((boolean_t) 1);
        }
                                ...
                                )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->IBCR_f.ACKE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->IBCR_f.ACKE = ((boolean_t) 1);
        }
                                 ...
                                 )
{
    ...
    else
    {
        ...
        {
            pstcI2c->IBCR_f.WSEL = ((boolean_t) 1);
        }
         
        else
        {
            pstcI2c->IBCR_f.WSEL = ((boolean_t) 0);
        }
                                       ...
                                       )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->IBCR_f.CNDE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->IBCR_f.CNDE = ((boolean_t) 1);
        }
                                ...
                                )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->IBCR_f.INTE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->IBCR_f.INTE = ((boolean_t) 1);
        }
...
{
    boolean_t bErrStatus = ((boolean_t) 0);
    ...
    if (0 != MfsGetInternDataPtr(pstcI2c))
    {
        ...
        if(((boolean_t) 1) == pstcI2c->IBCR_f.BER)
        {
            bErrStatus = ((boolean_t) 1);
        }
...
{
    boolean_t bIntStatus = ((boolean_t) 0);
    ...
    if (0 != MfsGetInternDataPtr(pstcI2c))
    {
        ...
        if(((boolean_t) 1) == pstcI2c->IBCR_f.INT)
        {
            bIntStatus = ((boolean_t) 1);
        }
...
en_result_t Mfs_I2c_ClearIntStatus(volatile stc_mfsn_t* pstcI2c)
{
    ...
    else
    {
        ...
        pstcI2c->IBCR_f.INT = ((boolean_t) 0);
...
en_result_t Mfs_I2c_SetTransmitEmpty(volatile stc_mfsn_t* pstcI2c)
{
    ...
    else
    {
        ...
        pstcI2c->SSR_f.TSET = ((boolean_t) 0);
                                    ...
                                    )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->SSR_f.DMA = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->SSR_f.DMA = ((boolean_t) 1);
        }
                                  ...
                                  )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bLevel)
        {
            pstcI2c->EIBCR_f.SDAC = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->EIBCR_f.SDAC = ((boolean_t) 1);
        }
                                  ...
                                  )
{
    ...
    else
    {
        ...
        if (PDLLow == bLevel)
        {
            pstcI2c->EIBCR_f.SCLC = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->EIBCR_f.SCLC = ((boolean_t) 1);
        }
                                      ...
                                      )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->EIBCR_f.SOCE = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->EIBCR_f.SOCE = ((boolean_t) 1);
        }
                                            ...
                                            )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcI2c->EIBCR_f.BEC = ((boolean_t) 0);
        }
         
        else
        {
            pstcI2c->EIBCR_f.BEC = ((boolean_t) 1);
        }
                        ...
                        )
{
    ...
    if ((0 == MfsGetInternDataPtr(pstcLin))
    ||  (0 == pstcConfig)
       )
    {
        return (ErrorInvalidParameter);
                                        ...
                                        )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcLin->ESCR_f.LBIE = ((boolean_t) 0);
        }
         
        else
        {
            pstcLin->ESCR_f.LBIE = ((boolean_t) 1);
        }
                                     ...
                                     )
{
    ...
    if (0 == MfsGetInternDataPtr(pstcMfs))
    {
        enResult = ErrorInvalidParameter;
    }
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcMfs->SMR_f.SOE = ((boolean_t) 0);
        }
         
        else
        {
            pstcMfs->SMR_f.SOE = ((boolean_t) 1);
        }
                                      ...
                                      )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcMfs->SMR_f.WUCR = ((boolean_t) 0);
        }
         
        else
        {
            pstcMfs->SMR_f.WUCR = ((boolean_t) 1);
        }
...
en_result_t Mfs_SoftwareReset(volatile stc_mfsn_t* pstcMfs)
{
    ...
    else
    {
        ...
        pstcMfs->SCR_f.UPCL = ((boolean_t) 1);
                           ...
                           )
{
    ...
    else
    {
        ...
        if (((boolean_t) 0) == bEnable)
        {
            pstcMfs->SCR_f.RXE = ((boolean_t) 0);
        }
         
        else
        {
            pstcMfs->SCR_f.RXE = ((boolean_t) 1);
        }
    ...
    else
    {
        ...
        switch (pstcFifoConfig->u8FifoSel)
        {
            case MfsTxFifo1RxFifo2:
                pstcMfs->FCR1_f.FSEL = ((boolean_t) 0);
                break;
            case MfsTxFifo2RxFifo1:
                pstcMfs->FCR1_f.FSEL = ((boolean_t) 1);
                break;
            default:
                enResult = ErrorInvalidParameter;
                break;
...
boolean_t Mfs_GetTxFifoReqStatus(volatile stc_mfsn_t* pstcMfs)
{
    ...
    if (0 != MfsGetInternDataPtr(pstcMfs))
    {
        ...
        if(((boolean_t) 1) == pstcMfs->FCR1_f.FDRQ)
        {
            bStatus = ((boolean_t) 1);
        }
...
en_result_t Mfs_ClrTxFifoReqStatus(volatile stc_mfsn_t* pstcMfs)
{
    ...
    else
    {
        ...
        pstcMfs->FCR1_f.FDRQ = ((boolean_t) 0);
                         ...
                         )
{
    ...
    else
    {
        ...
        {
            case MfsFifo1:
                pstcMfs->FCR0_f.FCL1 = ((boolean_t) 1);
                break;
            case MfsFifo2:
                pstcMfs->FCR0_f.FCL2 = ((boolean_t) 1);
                break;
            default:
                enResult = ErrorInvalidParameter;
                break;
    ...
    else
    {
        ...
        switch (u8FifoNumber)
        {
            case MfsFifo1:
                ...
                if (((boolean_t) 0) == bEnable)
                {
                    pstcMfs->FCR0_f.FE1 = ((boolean_t) 0);
                }
                 
                else
                {
                    pstcMfs->FCR0_f.FE1 = ((boolean_t) 1);
                }
                break;
            case MfsFifo2:
                ...
                if (((boolean_t) 0) == bEnable)
                {
                    pstcMfs->FCR0_f.FE2 = ((boolean_t) 0);
                }
                 
                else
                {
                    pstcMfs->FCR0_f.FE2 = ((boolean_t) 1);
                }
                break;
            default:
                enResult = ErrorInvalidParameter;
...
uint32_t Mfs_GetBusClock(void)
{
    ...
    switch (((FM4_CRG_TypeDef *)((0x40000000UL) + 0x10000UL))->SCM_CTL >> (0x05u))
    {
        case (0x00u):
            u32BusClock = ( 4000000ul);
            break;
        case (0x01u):
            u32BusClock = ( 4000000ul);
            break;
        case (0x02u):
            u32BusClock = (( 4000000ul)  * (((uint32_t)(((FM4_CRG_TypeDef *)((0x40000000UL) + 0x10000UL))->PLL_CTL2) & (0x3Fu)) + (0x01u)));
            u32BusClock /= ((((uint32_t)(((FM4_CRG_TypeDef *)((0x40000000UL) + 0x10000UL))->PLL_CTL1) >> (0x04u)) & (0x0Fu)) + (0x01u));
            break;
        case (0x04u):
            u32BusClock = ( 100000ul);
            break;
        case (0x05u):
            u32BusClock = ( 32768ul);
            break;
    ...
    switch (((FM4_CRG_TypeDef *)((0x40000000UL) + 0x10000UL))->APBC2_PSR & (0x03u))
    {
        case MfsClkDiv0:
            u32BusClock /= (0x01u);
            break;
