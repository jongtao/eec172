...
typedef void (* WyzBeeSpi_TxIsrCallBack_t)(void);	
typedef void (* WyzBeeSpi_RxIsrCallBack_t)(void);	

typedef enum WyzBeeSpi_BitLength							 
{
    SpiFiveBits        	= 0u,      					
    SpiSixBits         	= 1u,      					
    SpiSevenBits       	= 2u,    					
...
typedef enum WyzBeeSpi_WaitTimes							 
{
	SpiSyncWaitZero    	= 0u,           			
	SpiSyncWaitOne     	= 1u,           			
	SpiSyncWaitTwo     	= 2u,           			
...
typedef enum WyzBeeSpi_Mode									 
{
   SpiMaster        	= 0u,          				
   SpiSlave         	= 1u           				
} WyzBeeSpi_Mode_t;

typedef enum WyzBeeSpi_IntrConfig							 
{
	SpiUseIntrMode   	= 1u,          				
	SpiNoUseIntrmode 	= 0u          				
} WyzBeeSpi_IntrConfig_t;

typedef enum WyzBeeSpi_BitOrde								 
{
	SpiMsbBitFirst	    = 1u,          				
	SpiLsbBitFirst 	    = 0u          				
} WyzBeeSpi_BitOrde_t;

typedef enum WyzBeeSpi_Clock								 
{
	SpiClockMarkHigh    = 1u,          				
	SpiClockMarkLow 	= 0u          				
} WyzBeeSpi_Clock_t;
...
typedef struct WyzBeeSpi_Config								 
{
	uint32_t         			BaudRate;     		
	uint8_t          			Mode;         		
	uint8_t          			WaitTime;       	
	...
	WyzBeeSpi_TxIsrCallBack_t  	TxIsr;				
	WyzBeeSpi_RxIsrCallBack_t  	RxIsr;				
...
#line 44 ".\\WyzBee_i2c\\WyzBee_i2c.h"
...
typedef enum WyzBeeI2c_FrequencyDivsion		 
{
	I2cNoizeFilterLess40M  		=  0x00,   	
	I2cNoizeFilterLess60M  		=  0x01,   	
	I2cNoizeFilterLess80M  		=  0x02,   	
	I2cNoizeFilterLess100M 		=  0x03,   	
	I2cNoizeFilterLess120M 		=  0x04,   	
	I2cNoizeFilterLess140M 		=  0x05,   	
	I2cNoizeFilterLess160M 		=  0x06,   	
	I2cNoizeFilterLess180M 		=  0x07,   	
	I2cNoizeFilterLess200M 		=  0x08,   	
	I2cNoizeFilterLess220M 		=  0x09,   	
	I2cNoizeFilterLess240M 		=  0x0A,   	
	I2cNoizeFilterLess260M 		=  0x0B,   	
	I2cNoizeFilterLess280M 		=  0x0C,   	
	I2cNoizeFilterLess300M 		=  0x0D,   	
	I2cNoizeFilterLess320M 		=  0x0E,   	
	I2cNoizeFilterLess340M 		=  0x0F,   	
	I2cNoizeFilterLess360M 		=  0x10,   	
	I2cNoizeFilterLess380M 		=  0x11,   	
	I2cNoizeFilterLess400M 		=  0x12    	

} WyzBeeI2c_FrequencyDivsion_t;


typedef struct WyzBeeI2c_Config				 
{
	uint32		I2cDataRate;				
	uint8		I2cMode;					
	uint8		NoiseFilterConfig;			
	uint8       SlaveAddress;				

} WyzBeeI2c_Config_t;

typedef enum WyzBeeI2c_States				 
{
	I2cStateStandby         	=  0,       
	I2cStateReceiving    		=  1,       
	I2cStateTransmitting 		=  2        
} WyzBeeI2c_States_t;


typedef enum WyzBeeI2c_DataDirection		 
{
	I2cWrite 					=  0x00,    
	I2cRead  					=  0x01     
...
int main(void)
{
	...
	{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(0))); do{ *((volatile unsigned int*)(0x42DE81A8UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE41A8UL))=1u; *((volatile unsigned int*)(0x42DE01A8UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(0))); do{ *((volatile unsigned int*)(0x42DE21A8UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE41A8UL))=0u; *((volatile unsigned int*)(0x42DE01A8UL))=0u; }while(0); }while(0);}; 
	...
	for(;;)
	{
		...
		if(( *((volatile unsigned int*)(0x42DE6238UL)) ) && prev == 0) 
		{
			prev = 1; 
			...
			{
				case 0:
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(0))); do{ *((volatile unsigned int*)(0x42DE8208UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4208UL))=1u; *((volatile unsigned int*)(0x42DE0208UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(0))); do{ *((volatile unsigned int*)(0x42DE2208UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4208UL))=0u; *((volatile unsigned int*)(0x42DE0208UL))=0u; }while(0); }while(0);};
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1))); do{ *((volatile unsigned int*)(0x42DE8210UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4210UL))=1u; *((volatile unsigned int*)(0x42DE0210UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1))); do{ *((volatile unsigned int*)(0x42DE2210UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4210UL))=0u; *((volatile unsigned int*)(0x42DE0210UL))=0u; }while(0); }while(0);};
					color = 1;
						tft.fillScreen(0x0000);
					break;
				case 1:
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(0))); do{ *((volatile unsigned int*)(0x42DE820CUL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE420CUL))=1u; *((volatile unsigned int*)(0x42DE020CUL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(0))); do{ *((volatile unsigned int*)(0x42DE220CUL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE420CUL))=0u; *((volatile unsigned int*)(0x42DE020CUL))=0u; }while(0); }while(0);};
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1))); do{ *((volatile unsigned int*)(0x42DE8208UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4208UL))=1u; *((volatile unsigned int*)(0x42DE0208UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1))); do{ *((volatile unsigned int*)(0x42DE2208UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4208UL))=0u; *((volatile unsigned int*)(0x42DE0208UL))=0u; }while(0); }while(0);};
					color = 2;
					tft.fillScreen(0x0000);
					break;
				case 2:
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(0))); do{ *((volatile unsigned int*)(0x42DE8210UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4210UL))=1u; *((volatile unsigned int*)(0x42DE0210UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(0))); do{ *((volatile unsigned int*)(0x42DE2210UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4210UL))=0u; *((volatile unsigned int*)(0x42DE0210UL))=0u; }while(0); }while(0);};
					{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1))); do{ *((volatile unsigned int*)(0x42DE820CUL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE420CUL))=1u; *((volatile unsigned int*)(0x42DE020CUL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1))); do{ *((volatile unsigned int*)(0x42DE220CUL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE420CUL))=0u; *((volatile unsigned int*)(0x42DE020CUL))=0u; }while(0); }while(0);};
					color = 0;
					tft.fillScreen(0x0000);
					break;
				default:
		...
		if(!( *((volatile unsigned int*)(0x42DE6238UL)) ))
			prev = 0;
		...
		switch(color)
		{
			case 0: 
				...
				WyzBeeI2c_Write(0x40, command, 1);
				WyzBeeI2c_Read(0x40, i2cBuffer, &bufLen); 
			...
			case 2: 
				...
				bufLen = 6;
				command[0] = 0x3B;
				WyzBeeI2c_Write(0x68, command, 1);
				WyzBeeI2c_Read(0x68, i2cBuffer, &bufLen);
				...
				accel_x = (9.8) * ((int16_t)raw_accel_x) / (float)(1<<14);
				accel_y = (9.8) * ((int16_t)raw_accel_y) / (float)(1<<14);
				accel_z = (9.8) * ((int16_t)raw_accel_z) / (float)(1<<14);
