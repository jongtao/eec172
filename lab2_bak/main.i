...
{
	( *((volatile unsigned int*)(0x42DE8208UL))=(0) );
} 
...
int main(void)
{
	...
	do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(0))); do{ *((volatile unsigned int*)(0x42DE2080UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4080UL))=0u; *((volatile unsigned int*)(0x42DE0080UL))=0u; *((volatile unsigned int*)(0x42DEA000UL))=0u; }while(0); }while(0);
	
	do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(0))); do{ *((volatile unsigned int*)(0x42DE8088UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4088UL))=1u; *((volatile unsigned int*)(0x42DE0088UL))=0u; *((volatile unsigned int*)(0x42DEA008UL))=0u; }while(0); }while(0);

	do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1))); do{ *((volatile unsigned int*)(0x42DE8208UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4208UL))=1u; *((volatile unsigned int*)(0x42DE0208UL))=0u; }while(0); }while(0);
	...
	WyzBeeExtIntConfig.abEnable[11] = 1u;   
