#line 1 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 21 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 22 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 23 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 24 "WyzBee_oled\\Adafruit_SSD1351.cpp"
#line 1 ".\\common\\mfs.h"
...
#line 25 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 26 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
#line 27 "WyzBee_oled\\Adafruit_SSD1351.cpp"
...
void delayMicroseconds(uint32_t _delay) 
{
	uint32_t x;
...
void Adafruit_SSD1351::writeCommand(uint8_t c)
{
	...
	( *((volatile unsigned int*)(0x42DE8200UL))=(0u) );
	spiwrite(c);
}
...
{
	( *((volatile unsigned int*)(0x42DE8200UL))=(1u) ); 
	spiwrite(c);
}
...
void Adafruit_SSD1351::drawPixel(int16_t x, int16_t y, uint16_t color)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR4_f.P40 = 1u;   
...
void Adafruit_SSD1351::begin(void) {
	...
	do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1u))); do{ *((volatile unsigned int*)(0x42DE8200UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4200UL))=1u; *((volatile unsigned int*)(0x42DE0200UL))=0u; }while(0); }while(0); 
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->ADE=0;
	( *((volatile unsigned int*)(0x42DE8284UL))=(0u) );
	{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1u))); do{ *((volatile unsigned int*)(0x42DE8204UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4204UL))=1u; *((volatile unsigned int*)(0x42DE0204UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1u))); do{ *((volatile unsigned int*)(0x42DE2204UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4204UL))=0u; *((volatile unsigned int*)(0x42DE0204UL))=0u; }while(0); }while(0);};
	( *((volatile unsigned int*)(0x42DE8204UL))=(1u) );
	delay(500);
	( *((volatile unsigned int*)(0x42DE8204UL))=(0u) );
	delay(500);
	( *((volatile unsigned int*)(0x42DE8204UL))=(1u) );
	delay(500);
...
Adafruit_SSD1351::Adafruit_SSD1351(void) : Adafruit_GFX(128, 128) {
