...
err_t WyzBeeI2c_Init( WyzBeeI2c_Config_t    *p_config )
{
	...
	if(p_config  !=  0) 												
	{
		...
		if(retval == Ok)
		{
			Mfs_SetTxIntCallBack (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , WyzBeeI2c_TxIsr   );	
			Mfs_SetRxIntCallBack (&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , WyzBeeI2c_RxIsr   );	
			Mfs_SetStsIntCallBack(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38700UL))) , WyzBeeI2c_SatusIsr);	
