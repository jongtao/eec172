...
int main()
{
	...
	do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1))); do{ *((volatile unsigned int*)(0x42DE8088UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4088UL))=1u; *((volatile unsigned int*)(0x42DE0088UL))=0u; *((volatile unsigned int*)(0x42DEA008UL))=0u; }while(0); }while(0);

	
	for(;;)
		
	( *((volatile unsigned int*)(0x42DE8088UL))=(( *((volatile unsigned int*)(0x42DE6080UL)) )) );
