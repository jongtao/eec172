#line 1 "WyzBee_SPI\\WyzBee_spi.c"
...
#line 37 "WyzBee_SPI\\WyzBee_spi.c"
...
err_t WyzBeeSpi_Init(WyzBeeSpi_Config_t   *p_config)
{
	...
	stc_mfs_csio_config_t config_internal;							


	if(p_config!=0)												
	{
		memset(&config_internal,0,sizeof(stc_mfs_csio_config_t));	
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 =  ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5   | 0x0000001C;				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08= ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 | 0x00000150;				

	(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));							
	 
	res=Mfs_Csio_Init(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (stc_mfs_csio_config_t *)&config_internal);
	if(Ok != res)													
	{
	...
	Mfs_Csio_SetSckOutEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 1u);					
	Mfs_ErrorClear(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));									
	WyzBeeSpi_TxEnable();											
	WyzBeeSpi_RxEnable();											

	if(p_config->UseInterrupts==SpiUseIntrMode)						
	{
		Mfs_SetTxIntCallBack(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), p_config->TxIsr);		
		Mfs_SetRxIntCallBack(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), p_config->RxIsr);		

		Mfs_InitTxIrq(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));								
		Mfs_InitRxIrq(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));								
	}
	 
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5_f.P51  = 0u;										
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR5_f.P51  = 1u;									
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P51 = 1u;									
...
err_t WyzBeeSpi_SyncSend(uint8_t *p_buf , uint16_t buf_len)
{
	...
	if((p_buf!=0) && (buf_len!=0))								
	{
		...
		while(buf_len!=0)
		{
			do
			{														
				tx_status = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (0x02u));
			} while ((tx_status & (0x02u))!= (0x02u));

			
			WyzBeeSpi_Write(p_buf[Indx++]);								
			buf_len--;
		}
...
err_t WyzBeeSpi_SyncSendRecv(uint8_t *p_tx_buf , uint16_t tx_len , uint8_t *p_rx_buf , uint16_t rx_len)
{
	...
	if((p_tx_buf!=0) && (p_rx_buf !=0) && (tx_len!=0) && (rx_len!=0))
	{
		tx_char=0;
		WyzBeeSpi_CsEnable();										
		MaxTxRxCnt=((tx_len) > (rx_len) ? (tx_len) : (rx_len));
		...
		while(MaxTxRxCnt!=0)
		{
			...
			if(tx_buf_indx <= tx_len)
			{
				...
				WyzBeeSpi_Write(p_tx_buf[tx_buf_indx++]);							
			}
			else
			{
				tx_buf_indx=0;
				WyzBeeSpi_Write(0xFF);								
			}
			if(rx_buf_indx <= rx_len)
			{
				do
				{													
					rx_status = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), (0x04u));
				} while ((rx_status & (0x04u))!= (0x04u));

				rx_char = WyzBeeSpi_Read();							
...
err_t WyzBeeSpi_DeInit(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 =  ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR5 & ~(0x0000001C);				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08= ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 & ~(0x00000150);				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR5_f.P53  = 0u;									
...
void WyzBeeSpi_CsEnable(void)
{
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR5_f.P51 = 0u;									
...
err_t WyzBeeSpi_TxIntrEnable(void)
{
	...
	res = Mfs_SetTxIntEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 1u);					
	if(res==Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_TxIntrDisable(void)
{
	...
	res = Mfs_SetTxIntEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 0u);					
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_RxIntrEnable(void)
{
	...
	res = Mfs_SetRxIntEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 1u);					
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_RxIntrDisable(void)
{
	...
	res = Mfs_SetRxIntEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 0u);					
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_Write(uint8_t tx_char)
{
	...
	res = Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), send_char);						
	if(res == Ok)
	{
		return 0u;
	}
...
uint8_t WyzBeeSpi_Read(void)
{
	...
	rx_char = Mfs_ReadData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))));							
...
err_t WyzBeeSpi_RxEnable(void)
{
	...
	res = Mfs_SetRxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 1u);						
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_TxEnable(void)
{
	...
	res = Mfs_SetTxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 1u);						
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_RxDisable(void)
{
	...
	res = Mfs_SetRxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 0u);						
	if(res == Ok)
	{
		return 0u;
	}
...
err_t WyzBeeSpi_TxDisable(void)
{
	...
	res = Mfs_SetTxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38400UL))), 0u);						
	if(res == Ok)
